...
export default function LoginPage() {
  ...
  const handleSocialLogin = async (provider: string) => {
    ...
    try {
      // @todo github and github
      // for now i have done only google auth
          ...
          <div className="w-full max-w-md relative z-10">
            ...
            <div className="text-center mb-8">
              <div className="inline-block">
                <div
                  className="flex items-center justify-center w-14 h-14 rounded-xl mb-4 mx-auto"
            ...
            >
              ...
              <p
                ...
                style={{ color: "#BBE1FA", opacity: 0.4 }}
              >
                By continuing, you agree to our{" "}
                <a href="#" className="underline" style={{ color: "#3282B8" }}>
                  Terms
                </a>{" "}
                and{" "}
                <a href="#" className="underline" style={{ color: "#3282B8" }}>
